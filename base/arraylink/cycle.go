...
// NewCircleArray 自定义环形数组
func NewCircleArray[T any]() *CycleArray[T] {
	return NewCircleArrayWithSize[T](1)
}

// NewCircleArrayWithSize 初始化包含长度的环形数组
func NewCircleArrayWithSize[T any](size int) *CycleArray[T] {
	return &CycleArray[T]{
		arr:   make([]T, size),
		start: 0,
		end:   0,
